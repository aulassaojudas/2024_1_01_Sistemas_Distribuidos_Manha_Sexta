...
app.get("/profile/:user_id/address/:profile_address_id", (req, res) => perfilController.getPerfilEndById(req, res));
app.post("/profile/:user_id", (req, res) => perfilController.createPerfil(req, res));
app.put("/profile/:user_id/address/:profile_address_id", (req, res) => perfilController.updatePerfil(req, res));
app.delete("/profile/:user_id/address/:profile_address_id", (req, res) => perfilController.deletePerfil(req, res));
